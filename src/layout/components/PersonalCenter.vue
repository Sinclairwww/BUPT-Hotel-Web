<template>
  <div style="display: inline-block; display: inline-flex; vertical-align: middle">
    <el-dropdown trigger="click">
      ...
      <template #dropdown>
        <el-dropdown-menu>
          <el-dropdown-item v-for="menu in menuList" :key="menu.name" :to="menu.link" :divided="menu.divided"
            @click="routerChange(menu)">{{ menu.title }}</el-dropdown-item>
        </el-dropdown-menu>
      </template>
    </el-dropdown>
